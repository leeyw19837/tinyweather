...
<html>
    <head>
        ...
        <title>DELETE - httpx.js Examples</title>
        <link rel="stylesheet" href="css/global.css">
    </head>
    <body>
        <div id="layout">
            <header>
                <h1>DELETE Examples</h1>    
        ...
        <script>   
            ...
            httpx.delete("./php/delete.php?edfd=eedfd&dfsdf=ere", {
                a : 12,
                b : "bbbb",
                c : 123489
            }, function(data) {
            ...
            httpx.delete({
                ...
                url : "http://localhost/httpx.js/examples/php/delete.php?edfd=eedfd&dfsdf=ere",
                data : {id : 1233, add_time: (new Date).getTime()},
            ...
            httpx.delete({
                ...
                url : "http://localhost/httpx.js/examples/php/delete3.php?edfd=eedfd&dfsdf=ere",
                data : {id : 1233, add_time: (new Date).getTime()},
                success : function(data) {
            ...
            // Cross domain
            httpx.delete("http://api.httpxjs.com/?edfd=eedfd&dfsdf=ere", {
                a : 12,
                b : "bbbb",
                c : 123489
            }, function(data) {
                $("output4").innerText = "Cross domain DELETE request:\n\n" + this.$request.url + "\n\n" + data;
                console.log(data, this);
            });
        </script>
    </body>
