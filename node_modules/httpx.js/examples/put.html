...
<html>
    <head>
        ...
        <title>PUT - httpx.js Examples</title>
    ...
    <body>
        ...
        <script>   
            ...
            httpx.put("./php/put.php?edfd=eedfd&dfsdf=ere", {
                a : 12,
                b : "bbbb",
                c : 123489
            }, function(data) {
            ...
            httpx.put({
                ...
                url : "http://localhost/httpx.js/examples/php/put.php?edfd=eedfd&dfsdf=ere",
            ...
            httpx.put({
                ...
                url : "http://localhost/httpx.js/examples/php/put3.php?edfd=eedfd&dfsdf=ere",
                data : {id : 1233, add_time: (new Date).getTime()},
                success : function(data) {
            ...
            // Cross domain
            httpx.put("http://api.httpxjs.com/?edfd=eedfd&dfsdf=ere", {
                a : 12,
                b : "bbbb",
                c : 123489
            }, function(data) {
                $("output4").innerText = "Cross domain PUT request:\n\n" + this.$request.url + "\n\n" + data;
                console.log(data, this);
            });
        </script>
    </body>
